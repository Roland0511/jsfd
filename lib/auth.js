...
const possibleEnvPaths = [
  ...
  path.resolve(os.homedir(), '.jafd', '.env'),
...
try {
    const possibleConfigPaths = [
        path.resolve(process.cwd(), 'jafd.json'),
        path.resolve(process.cwd(), 'config.json'),
        path.resolve(os.homedir(), '.jafd', 'config.json'),
...
const TOKEN_CACHE_FILE = path.resolve(os.homedir(), '.jafd', 'cache', 'feishu_token.json');
